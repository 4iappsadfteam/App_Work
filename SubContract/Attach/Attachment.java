...
public class FileAttachment {
    ...
    public static String UploadFileToDB(UploadedFile file, ViewObject vo) {
        ...
        public static void downloadFileListener(FacesContext facesContext, OutputStream outputStream, ViewObject vo) {
              BlobDomain blob =(BlobDomain)vo.getCurrentRow().getAttribute("Attachment");
              try {
                      if(blob!=null){ 
