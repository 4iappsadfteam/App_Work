...
DecimalFormat df = new DecimalFormat("");
    public String readExcelSellSheet(InputStream xlsx, RichTable t1, Object HrdID) throws IOException,InvalidFormatException,ParseException {
        org.apache.poi.ss.usermodel.Workbook workbook = null;
        List<String> errorRows = new ArrayList<String>();
        String rowNum=null;
        String excelStatus="N";
...
//                                                            System.out.println("getCellType 0===>>"+MytempCell.getCellType());
                                                                ...
                                                                case 0:
                                                                    linerow.setAttribute("ContHeaderId", HrdID);
                                                                    linerow.setAttribute("RelLineNumber", df.format(MytempCell.getNumericCellValue()));
                                                                }
                                                            System.err.println("==0==>"+linerow.getAttribute("RelLineNumber")); 
                                                        }else{
                                                            System.err.println("!!!!!!!!!Relation number is blank!!!!!!!!!");
//                                                            if(rowNum==null){
//                                                                 rowNum="Row: "+skipcnt;
...
//                                                            System.out.println("getCellType 1===>>"+MytempCell.getCellType());
                                                            ...
                                                            case 1:
                                                                ...
                                                                break;
                                                            case 0:
                                                                linerow.setAttribute("ContractLineNumber", df.format(MytempCell.getNumericCellValue()));
                                                                break;
                                                            }
                                                            System.err.println("==1==>"+linerow.getAttribute("ContractLineNumber")); 
                                                        }else{
                                                            System.err.println("!!!!!!!!!Line number is blank!!!!!!!!!");
//                                                            if(rowNum==null){
//                                                                 rowNum="Row: "+skipcnt;
...
//                                                            System.out.println("getCellType 2===>>"+MytempCell.getCellType());
                                                            ...
                                                            case 1:
                                                                ...
                                                                break;
                                                            case 0:
                                                                linerow.setAttribute("ItemDescription", df.format(MytempCell.getNumericCellValue()));
                                                                break;
                                                            }
                                                            
                                                            System.err.println("==2==>"+linerow.getAttribute("ItemDescription")); 
                                                        }else{
                                                            System.err.println("!!!!!!!!!ProjectNumber is blank!!!!!!!!!");
//                                                            if(rowNum==null){
//                                                                 rowNum="Row: "+skipcnt;
...
//                                                            System.out.println("getCellType 3===>>"+MytempCell.getCellType());
                                                            ...
                                                            case 1: 
                                                                ...
                                                                break;
                                                            case 0:
                                                                linerow.setAttribute("Uom", df.format(MytempCell.getNumericCellValue()));
                                                                break;
                                                            }
                                                            // task Id
                                                            System.err.println("==3==>"+linerow.getAttribute("Uom")); 
...
//                                                            System.out.println("getCellType 9===>>"+MytempCell.getCellType());
                                                            ...
                                                            case 0:
                                                                linerow.setAttribute("OrigQuantity", df.format(MytempCell.getNumericCellValue()));
                                                                break;
                                                            }
                                                            System.err.println("==9==>"+linerow.getAttribute("OrigQuantity"));  
                                                        }else{
//                                                            System.err.println("!!!!!!!!!Qty is blank!!!!!!!!!");
//                                                            if(rowNum==null){
//                                                                 rowNum="Row: "+skipcnt;
...
//                                                            System.out.println("getCellType 10===>>"+MytempCell.getCellType());
                                                            ...
                                                            case 1:
                                                                ...
                                                                break;
                                                            case 0: 
                                                                linerow.setAttribute("OrigUnitPrice", df.format(MytempCell.getNumericCellValue()));
                                                                break;
                                                            }
                                                            // Price
                                                            System.err.println("==10==>"+linerow.getAttribute("OrigUnitPrice"));  
                                                            double qty=linerow.getAttribute("OrigQuantity")==null?0:Double.parseDouble(linerow.getAttribute("OrigQuantity").toString());
                                                            double prz=linerow.getAttribute("OrigUnitPrice")==null?0:Double.parseDouble(linerow.getAttribute("OrigUnitPrice").toString());
                                                            double amt=qty*prz;
                                                            linerow.setAttribute("OrigAmount", amt);
                                                            ...
                                                            // System.out.println("getCellType 3===>>"+MytempCell.getCellType());
                                                                ...
                                                                case 1: 
                                                                    ...
                                                                    break;
                                                                case 0:
                                                                    linerow.setAttribute("ProjectNumber", df.format(MytempCell.getNumericCellValue()));
                                                                    break;
                                                                }
                                                                // task Id
                                                                System.err.println("==3==>"+linerow.getAttribute("ProjectNumber")); 
                                                            ...
                                                            //    System.out.println("getCellType 3===>>"+MytempCell.getCellType());
                                                                ...
                                                                case 1: 
                                                                    ...
                                                                    break;
                                                                case 0:
                                                                    linerow.setAttribute("TaskNumber", df.format(MytempCell.getNumericCellValue()));
                                                                    break;
                                                                }
                                                                // task Id
                                                                System.err.println("==3==>"+linerow.getAttribute("TaskNumber")); 
